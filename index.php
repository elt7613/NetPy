...
<head>
    ...
    <link rel="stylesheet" href="css/landing_page/section_1.css">
    <link rel="stylesheet" href="css/landing_page/section_2.css">
    <link rel="stylesheet" href="css/landing_page/section_3.css">
    <link rel="stylesheet" href="css/landing_page/section_4.css">
    <link rel="stylesheet" href="css/landing_page/section_5.css">
    <link rel="stylesheet" href="css/landing_page/section_6.css">
    ...
    <script src="index-navbar-services.js"></script>
...
<body>
    ...
    <section class="section-1">
        <h1>Together we <span class="highlight">develop</span></h1>
        <p>We take pride in our unwavering attention to detail, ensuring the highest level of precision and quality in every service. <br>Our commitment to excellence fosters trust and guarantees reliability in every project we deliver</p>

        <!-- Contacy US Button-->
        <div class="contact-main_div">
            <div class="social_media">
                <a href="https://wa.me/9036187196" target="_blank">
                    <i class="fab fa-whatsapp"></i>
                </a>
                <a href="mailto:info@netpy.in?subject=Inquiry%20for%20NetPy" target="_blank">
                    <i class="fa fa-envelope"></i>
                </a>
                <a href="contact.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 1024 1024">
                    	<path fill="#fff" d="M464 512a48 48 0 1 0 96 0a48 48 0 1 0-96 0m200 0a48 48 0 1 0 96 0a48 48 0 1 0-96 0m-400 0a48 48 0 1 0 96 0a48 48 0 1 0-96 0m661.2-173.6c-22.6-53.7-55-101.9-96.3-143.3a444.4 444.4 0 0 0-143.3-96.3C630.6 75.7 572.2 64 512 64h-2c-60.6.3-119.3 12.3-174.5 35.9a445.4 445.4 0 0 0-142 96.5c-40.9 41.3-73 89.3-95.2 142.8c-23 55.4-34.6 114.3-34.3 174.9A449.4 449.4 0 0 0 112 714v152a46 46 0 0 0 46 46h152.1A449.4 449.4 0 0 0 510 960h2.1c59.9 0 118-11.6 172.7-34.3a444.5 444.5 0 0 0 142.8-95.2c41.3-40.9 73.8-88.7 96.5-142c23.6-55.2 35.6-113.9 35.9-174.5c.3-60.9-11.5-120-34.8-175.6m-151.1 438C704 845.8 611 884 512 884h-1.7c-60.3-.3-120.2-15.3-173.1-43.5l-8.4-4.5H188V695.2l-4.5-8.4C155.3 633.9 140.3 574 140 513.7c-.4-99.7 37.7-193.3 107.6-263.8c69.8-70.5 163.1-109.5 262.8-109.9h1.7c50 0 98.5 9.7 144.2 28.9c44.6 18.7 84.6 45.6 119 80c34.3 34.3 61.3 74.4 80 119c19.4 46.2 29.1 95.2 28.9 145.8c-.6 99.6-39.7 192.9-110.1 262.7" />
                    </svg>
                </a>
            </div>
        </div>
        ...
        <div class="floating-animation">
            <img src="images/landing_page/section-1/floating-uiux.png" class="uiux">
            <img src="images/landing_page/section-1/floating-app-dev.png" class="app-dev">
            <img src="images/landing_page/section-1/floating-mentorship.png" class="mentorship">
            <img src="images/landing_page/section-1/floating-software-dev.png" class="software-dev">
            <img src="images/landing_page/section-1/floating-ai-robotics-iot.png" class="ai-robotics-iot">
            <img src="images/landing_page/section-1/floating-devops.png" class="devops">
            <img src="images/landing_page/section-1/floating-cloud-solutions.png" class="cloud-solutions">
        </div>
