document.addEventListener('DOMContentLoaded', () => {
    const slider = document.querySelector('.section-3 .slider-container .slider');
    const slides = document.querySelectorAll('.section-3 .slider-container .slide');
    const prevBtn = document.querySelector('.section-3 .slider-container .prev');
    const nextBtn = document.querySelector('.section-3 .slider-container .next');
    let currentSlide = 0;
