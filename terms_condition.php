...
<body>
    ...
    <section class="terms-condition">
        <div class="header">
            <h1>Netpy Terms and Conditions </h1>
        </div>

        <div class="content">
            <p>
                Welcome to NetPy Technologies.
                These Terms and Conditions govern your use of our applications, services, websites, and other data processing activities where we act as a data controller.
            ...
            This document outlines the rules and guidelines for using NetPy Technologies' services, including IT solutions, robotics learning programs, mentorship opportunities, and internships.
            </p>

            <p>
            <h2>2. Changes to the Agreement</h2><br />
            We reserve the right to modify these Terms and Conditions at any time.
            We will notify you of any changes by posting the updated terms on our website with an updated effective date.
            Your continued use of our services after such changes constitutes acceptance of the new Terms and Conditions.
            </p>

            <p>
            <h2>3. User Guidelines and Acceptable Uses</h2><br />
            Users agree to:
            <br /><br />
            <ul>
                <li>Use our services only for lawful purposes.</li>
                <li>Not engage in any conduct that restricts or inhibits anyone's use or enjoyment of our services.</li>
                <li>Not transmit any harmful or illegal content.</li>
            </ul>
            </p>

            <p>
            <h2>4. Intellectual Property</h2><br />
            All content provided by NetPy Technologies, including text, graphics, logos, and software, is the property of NetPy Technologies or its licensors and is protected by copyright laws.
            Users are granted a limited license to access and use this content for personal, non-commercial purposes.
            </p>

            <p>
            <h2>5. Limitation of Liability</h2><br />
            NetPy Technologies shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of our services or inability to use them.
            This limitation applies to all claims regardless of their nature.
            </p>

            <p>
            <h2>6. Dispute Resolution</h2><br />
            In the event of a dispute arising out of or relating to these Terms and Conditions or your use of our services, you agree to resolve the dispute through binding arbitration in accordance with applicable laws.
            </p>
            ...
            <p>
            <h2>8. Termination</h2><br />
            NetPy Technologies reserves the right to terminate your access to our services at any time without notice if you violate these Terms and Conditions.
            </p>

            <p>
            <h2>9. Contact Information</h2><br />
            For any questions regarding these Terms and Conditions, please contact us at support@netpy.in.
            <br /><br />
            By using our services, you acknowledge that you have read, understood, and agreed to these Terms and Conditions. Thank you for choosing NetPy Technologies!
            </p>
        </div>
    </section>
