...
require_once 'email/contact_email.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = sendContactEmail($userData);
    ...
    <section class="contact-page">
        <div class="container">
            ...
            <div class="contact-options">
                ...
                <div class="contact-box">
                    ...
                    <div class="social-icons">
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/company/netpy-tech">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                                <g fill="none" stroke="#0D47A1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/netpykidz">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                                <g fill="none" stroke="#0D47A1" stroke-width="2">
                    ...
                    <div class="social-icons">
                        <!-- Twitter -->
                        <a href="https://x.com/netpytech">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 14 14">
                                <g fill="none">
                                    <g clip-path="url(#primeTwitter0)">
                                        <path fill="#0047AB" d="M11.025.656h2.147L8.482 6.03L14 13.344H9.68L6.294 8.909l-3.87 4.435H.275l5.016-5.75L0 .657h4.43L7.486 4.71zm-.755 11.4h1.19L3.78 1.877H2.504z" />
                                    </g>
                                    <defs>
                        ...
                        <a href="https://discord.gg/jZEQG4yv" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24">
                                ...
                                <g fill="none" stroke="#0e47a1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
            ...
            <div class="form-container">
                <h3 style="color: #181818;">Tell Us How We Can Help You</h3>
